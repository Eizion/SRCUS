		...
		<form name="evaluation" action="selectEvaluation" method="post">
    			<table>
    				<tr>
     				...
     				<tr>
	    				<td><label>Term:</label></td>
     					<td><select name="term" id="term" required onChange="getCourse(this.value);">
    				...
    				<tr>
     					...
     					<td><select name="courseID" id="courseID" required onChange="getInstructor(this.value);" >
    				...
    				<tr>
    					<td><label>Instructor Name:</label></td>
     					<td><select name="instrID" id="instrID" required >
